...
void PlayLevel::BeginPlay()
{
	...
	UEngineSound::Load(NewPath.AppendPath("Effect\\CollectableGrap.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Destroy_0.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Destroy_1.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Destroy_2.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Go.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\HeavyMachineGun_Launch.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\KnifeAttack1.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\KnifeAttack2.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Marco_Death.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Pistol_Launch.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Prisioner.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\President.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\RocketLauncher_Hit.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\SoldierDeath_0.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\SoldierDeath_1.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\SoldierDeath_2.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Thunder.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\TombSpawn.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\WeaponEquip.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Zombie_Attack.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Zombie_ManDeath.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Zombie_WomanDeath.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Zombie_Marco_Death.mp3"));
	UEngineSound::Load(NewPath.AppendPath("Effect\\Zombie_Marco_Vomit.mp3"));
