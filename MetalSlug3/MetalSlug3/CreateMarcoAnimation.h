...
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_Shoot_Right", "Marco_UpperBody.png", 134, 137, 0.07f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_ForwardJumpShoot_Right", "Marco_UpperBody.png", 134, 137, 0.08f, false);\
...
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimNormalToUpShoot_Right", "Marco_UpperBody.png", 186, 187, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimUpToNormalShoot_Right", "Marco_UpperBody.png", 188, 189, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("Rifle_UpperBody_AimNormalToDown_Right", "Marco_UpperBody.png", 190, 192, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("Rifle_UpperBody_AimDownToNormal_Right", "Marco_UpperBody.png", 193, 195, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimDownShoot_Right", "Marco_UpperBody.png", 196, 199, 0.08f, false);\
...
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimNormalToDownShoot_Right", "Marco_UpperBody.png", 207, 208, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimDownToNormalShoot_Right", "Marco_UpperBody.png", 209, 210, 0.08f, false);\
\
...
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("Rifle_UpperBody_ForwardJumpShoot_Left", "Marco_UpperBody.png", 358, 367, 0.08f, false);\
...
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimUpShoot_Left", "Marco_UpperBody.png", 396, 399, 0.08f, false);\
...
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimNormalToUpShoot_Left", "Marco_UpperBody.png", 406, 407, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimUpToNormalShoot_Left", "Marco_UpperBody.png", 408, 409, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("Rifle_UpperBody_AimNormalToDown_Left", "Marco_UpperBody.png", 410, 412, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("Rifle_UpperBody_AimDownToNormal_Left", "Marco_UpperBody.png", 413, 415, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimDownShoot_Left", "Marco_UpperBody.png", 416, 419, 0.08f, false);\
...
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimNormalToDownShoot_Left", "Marco_UpperBody.png", 427, 428, 0.08f, false);\
Renderer[static_cast<int>(BodyRenderer::UpperBody)]->CreateAnimation("HeavyMachineGun_UpperBody_AimDownToNormalShoot_Left", "Marco_UpperBody.png", 429, 430, 0.08f, false);\
\
...
Renderer[static_cast<int>(BodyRenderer::AllBody)]->CreateAnimation("HeavyMachineGun_AllBody_Crouch_Shoot_Left", "Marco_AllBody.png", 543, 546, 0.08f, false);\
